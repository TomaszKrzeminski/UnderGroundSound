...
namespace UndergroundSound.Migrations
{
    ...
    [Migration("20190710155114_Adding interface to add Pictures")]
    partial class AddinginterfacetoaddPictures
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UndergroundSound.Models.CityPoland", b =>
                {
                    b.Property<int>("CityPolandId")
                        .ValueGeneratedOnAdd();

                    b.Property<string>("CityName");

                    b.Property<int?>("CountryPolandCountyPolandId");

                    b.HasKey("CityPolandId");

                    b.HasIndex("CountryPolandCountyPolandId");

                    b.ToTable("Cities");
                });

            modelBuilder.Entity("UndergroundSound.Models.CountyPoland", b =>
                {
                    b.Property<int>("CountyPolandId")
                        .ValueGeneratedOnAdd();

                    b.Property<string>("CountyName");

                    b.Property<int?>("ProvincePolandId");

                    b.HasKey("CountyPolandId");

                    b.HasIndex("ProvincePolandId");

                    b.ToTable("CountysPoland");
                });
            ...
            modelBuilder.Entity("UndergroundSound.Models.ProvincePoland", b =>
                {
                    b.Property<int>("ProvincePolandId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("ProvincePolandId");

                    b.ToTable("ProvincesPoland");
                });
            ...
            modelBuilder.Entity("UndergroundSound.Models.CityPoland", b =>
                {
                    b.HasOne("UndergroundSound.Models.CountyPoland", "CountryPoland")
                        .WithMany("Cities")
                        .HasForeignKey("CountryPolandCountyPolandId");
                });

            modelBuilder.Entity("UndergroundSound.Models.CountyPoland", b =>
                {
                    b.HasOne("UndergroundSound.Models.ProvincePoland", "ProvincePoland")
                        .WithMany("Countys")
                        .HasForeignKey("ProvincePolandId");
                });
